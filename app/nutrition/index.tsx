import { Text, View, Image, StyleSheet, ScrollView, Pressable, Share } from "react-native";
...
export default function Nutrition() {
  ...
  const { data, isFetching, error } = useQuery({
    ...
    queryFn: async () => {
      try {
        if (!user){
          throw new Error ('Failed loading nutrition')
        }
          ...
          <>
            ...
            <ScrollView>
                ...
                {data.refeicoes.map(refeicao => (
                  <>
                    <View key={refeicao.nome} style={styles.food}>
                      <View key={refeicao.nome} style={styles.foodHeader}>
              ...
              <View style={styles.supplements}>
                <Text style={styles.foodName}>Dicas supementos: </Text>
