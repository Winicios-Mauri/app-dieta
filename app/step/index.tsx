...
export default function Step(){
  ...
  function handleCreate(data: FormData){
    console.log("Passando os dados da Pagina 1")
    setPageOne({
      name: data.name,
      weight: data.weight,
      age: data.age,
  ...
  return(
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        ...
        <Input name="name" control={control} placeholder="Digite o seu nome..." error={errors.name?.message} keyboardType="default"/>
        ...
        <Input name="height" control={control} placeholder="Ex: 1.78" error={errors.height?.message} keyboardType="numeric"/>

        <Text style={styles.label}>Sua Idade:</Text>
        <Input name="age" control={control} placeholder="Ex: 28" error={errors.age?.message} keyboardType="numeric"/>
